...
declare module pouchDB {
  interface IPouchDB {
    ...
    on(/** Possible Events: "changed", "paused", "active", "denied", "complete", "error", "destroyed" */
       event: string,
    ...
    createIndex(index: IPouchDBIndex): Promise<any>;
    createIndex(index: IPouchDBIndex, callback: (err: IError, res: any) => void): any;
    getIndexes(): Promise<any>;
    getIndexes(callback: (err: IError, res: any) => void): any;
    deleteIndex(index: IPouchDBIndex): Promise<any>;
    deleteIndex(index: IPouchDBIndex, callback: (err: IError, res: any) => void): any;
    find(request: IPouchDBFindRequest): Promise<any>;
    find(request: IPouchDBFindRequest, callback: (err: IError, res: any) => void): any;
  ...
  interface IPouchDBOn {
    on(/** Possible Events: "changed", "paused", "active", "denied", "complete", "error" */
       event: string,
